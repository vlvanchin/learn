...
## $ cat htaccess.j2
AuthUserFile /var/www/html/secure/.passwdfile
AuthGroupFile /dev/null
AuthName "Who sent you"
AuthType Basic
require valid-user
...
### Encrypt */home/ansible/secret* using the *ansible-vault* command.
Run ansible-vault encrypt /home/ansible/secret 

- and provide a simple password of your choosing.
> password choosen was "james"
...
- example: echo "<Your_Vault_Password>" > /home/ansible/vault

$ echo "james" > /home/ansible/vault
...
[ansible@control1 ~]$ curl http://node1/secure/classified.html
